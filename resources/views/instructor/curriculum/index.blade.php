                        ...
                        <div class="tab-pane active" id="tabs-1" role="tabpanel">
                            @if(count($course->sections) >0)
                                <div class="text-center mb-5">
                                    <a class="primary-btn" href="{{route('instructor.curriculum.add', $course->id)}}">
                            ...
                            @else
                                <div class="text-center">
                                    <a href="{{route('instructor.curriculum.add', $course->id)}}" class="primary-btn">
                                        <i class="fas fa-plus">Ajouter ma première section</i>
                                    </a>
                                </div>
                            @endif
                        </div>
